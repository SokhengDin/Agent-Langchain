...
class BookingTools:
    """Tools for managing booking operations in the hotel system"""
    ...
    async def cancel_guest_booking(
        ...
        try:
            ...
            logger.info(
                f"Guest {guest_id} bookings cancelled successfully"
            )
    ...
    async def get_guest_bookings(
        ...
        try:
            ...
            response = await APIUtils.get(
                endpoint = f"/api/v1/booking/guest/{guest_id}/bookings"  # Fixed path
                , params = params
            )
    ...
    async def list_bookings(
        ...
        try:
            ...
            response = await APIUtils.get(
                endpoint = "/api/v1/booking/"  # Fixed: Changed from "/list" to "/"
                , params = params
            )
